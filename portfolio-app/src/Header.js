            ...
            <div className="row">
                ...
                <div className="col text-center text-lg-start">
                    ...
                    <ul className="list-inline">
                        <li className="list-inline-item my-2"><a href="mailto: Joshuasmlaw@gmail.com" className="fs-5 link-light text-decoration-none"><i
                        ...
                        <li className="list-inline-item my-2"><a href="#" className="fs-5 link-light text-decoration-none"><i
                                ...
                                LinkedIn</a></li>
                        <li className="list-inline-item my-2"><a href="https://github.com/x4n6u" className="fs-5 link-light text-decoration-none"><i
